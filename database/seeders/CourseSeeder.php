    ...
    public function run(): void
    {
        ...
        $courses = [
            ...
            [
                ...
                'curriculum_category_id' => $categories->where('title', 'Mathematics')->first()->id ?? $categories->first()->id,
                'course_category_id' => $categories->where('title', 'Mathematics')->first()->id ?? $categories->first()->id,
            ...
            [
                ...
                'curriculum_category_id' => $categories->where('title', 'English')->first()->id ?? $categories->first()->id,
                'course_category_id' => $categories->where('title', 'English')->first()->id ?? $categories->first()->id,
            ...
            [
                ...
                'curriculum_category_id' => $categories->where('title', 'Science')->first()->id ?? $categories->first()->id,
                'course_category_id' => $categories->where('title', 'Science')->first()->id ?? $categories->first()->id,
            ...
            [
                ...
                'curriculum_category_id' => $categories->where('title', 'Computer Science')->first()->id ?? $categories->first()->id,
                'course_category_id' => $categories->where('title', 'Computer Science')->first()->id ?? $categories->first()->id,
            ...
            [
                ...
                'curriculum_category_id' => $categories->where('title', 'History')->first()->id ?? $categories->first()->id,
                'course_category_id' => $categories->where('title', 'History')->first()->id ?? $categories->first()->id,
                'instructor_id' => $instructors->skip(1)->first()->id ?? $instructors->first()->id,
                'term_id' => $terms->first()->id,
                'level_id' => $levels->first()->id,
                'free_subscription' => false,
            ...
            [
                ...
                'curriculum_category_id' => $categories->where('title', 'Geography')->first()->id ?? $categories->first()->id,
                'course_category_id' => $categories->where('title', 'Geography')->first()->id ?? $categories->first()->id,
                'instructor_id' => $instructors->skip(2)->first()->id ?? $instructors->first()->id,
                'term_id' => $terms->first()->id,
                'level_id' => $levels->first()->id,
                'free_subscription' => false,
            ...
            [
                ...
                'curriculum_category_id' => $categories->where('title', 'Economics')->first()->id ?? $categories->first()->id,
                'course_category_id' => $categories->where('title', 'Economics')->first()->id ?? $categories->first()->id,
                'instructor_id' => $instructors->skip(3)->first()->id ?? $instructors->first()->id,
                'term_id' => $terms->first()->id,
                'level_id' => $levels->first()->id,
                'free_subscription' => false,
