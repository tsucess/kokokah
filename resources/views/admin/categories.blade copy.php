                    ...
                    <div class="card border-0 shadow-sm rounded-3" style="background: #f9f9f9; border: 1px solid #e8e8e8;">
                        <div class="card-body p-4 d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">Mathematic, Physics, Chemistry,
                                    Further Mathematics, Agricultural Science</p>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-3" style="background: #f9f9f9; border: 1px solid #e8e8e8;">
                        <div class="card-body p-4 d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">English Language,
                                    Literature-in-English, Government, CRS</p>
                            </div>
                            <div class="d-flex gap-2 ms-3">
                                <button class="btn btn-sm btn-light" style="border: 1px solid #ddd; color: #666;">
                                    <i class="fa-solid fa-pen"></i>
                    ...
                    <div class="card border-0 shadow-sm rounded-3" style="background: #f9f9f9; border: 1px solid #e8e8e8;">
                        <div class="card-body p-4 d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">Civic Education, ICT, Physical and
                                    Health Education</p>
                            </div>
                            <div class="d-flex gap-2 ms-3">
                                <button class="btn btn-sm btn-light" style="border: 1px solid #ddd; color: #666;">
