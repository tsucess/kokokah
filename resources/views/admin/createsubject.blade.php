    ...
    <main>
        ...
        <div class = "container bg-white d-none content-section" id="curriculum">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class = "d-flex gap-4">
                    <button class = " rounded coursedraft">
                        Save As Draft
                    </button>
                    <button class = " rounded coursedraft">
                        Save As Draft
                    ...
                    <div class="row mt-3">
                        <form>
                            ...
                            <div class="custom-form-group">
                                <label for="coursetitle" class="custom-label">Subject Title</label>
                                <input type="text" class="form-control-custom" id="subjectTitle" name="subjectTitle"
                                    placeholder="Enter Subject Title" aria-label="Subject Title" autocomplete="subject"
                                    required>
                            </div>
                            ...
                            <div class = "d-flex gap-2">
                                <div class="w-50 custom-form-group">
                                    ...
                                    <input type="text" class="form-control-custom" id="subjectTime" name="subjectTime"
                                        placeholder="Enter Subject Time" aria-label="Subject Time"
                                        autocomplete="subject time" required>
                                </div>
                                ...
                                <div class="w-50 custom-form-group">
                                    ...
                                    <input type="text" class="form-control-custom" id="totallesson" name="totallesson"
                                        placeholder="Enter Total Lesson" aria-label="Total Lesson"
                                        autocomplete="total lesson" required>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <form id="uploadForm bg-primary">
                                        ...
                                        <div class="d-flex mb-3 w-100">
                                            <input type="text" class="form-control file-name-input flex-grow-1"
                                                id="fileNameDisplay" placeholder="No file selected" readonly>
                                            <button class="btn btn-nav-primary" style="padding: 12px 120px;">Upload
                                                File</button>
                                        </div>
                        ...
                        <div class="d-flex flex-column gap-3">
                                    ...
                                    <div class="d-flex flex-column gap-3">
                                        ...
                                        <div class="d-flex gap-2 align-items-center">
                                            ...
                                            <div class="d-flex aling-items-center gap-1"><i class="fa-solid fa-landmark"
                                                    style="color: #000000;"></i> <span class="subject-subtext">Jss
                                                    1</span></div>
                                        </div>
                            ...
                            <article class="d-flex flex-column subject-overview-description-container">
                                ...
                                <div class="d-flex gap-2 flex-column">
                                    <p class="subject-overview-description-text">English Language is designed to equip
                                        learners
                                        with the skills needed to communicate effectively in both spoken and written forms.
                                        The
                                        subject focuses on grammar, vocabulary, comprehension, writing, and oral
                                        communication.
                                        Learners
                                        will develop the ability to read with understanding, write clearly and creatively,
                                        listen
                                        attentively, and speak confidently in different contexts. Through interactive
                                        lessons,
                                        practice exercises, and assessments, students will
                                        build a strong foundation in grammar and vocabulary, improve their reading and
                                        writing
                                        skills, and learn to express themselves fluently and accurately. By the end of the
                                        course,
                                        learners will not only master the technical aspects
                                        of English but also gain the confidence to apply the language in academic,
                                        professional, and
                                        everyday life. </p>
                                        ...
                                        <div class="d-flex gap-3 align-items-center">
                                            ...
                                            <div class="d-flex flex-column gap-1">
                                                ...
                                                <div class="d-flex gap-1 align-items-center">
                                                    <div class="d-flex aling-items-center gap-1"><i
                                                            class="fa-solid fa-circle-play" style="color: #000000;"></i>
                                                        <span class="subject-subtext">11 Lesson</span></div>
                                                    <div class="d-flex aling-items-center gap-1"><i
                                                            class="fa-solid fa-question" style="color: #000000;"></i>
                                                        <span class="subject-subtext">10
                                                            Quiz</span></div>
