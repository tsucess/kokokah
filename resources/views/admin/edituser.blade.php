            ...
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div>
                    <h1 class="fw-bold mb-2"
                        style=" color: #004A53; font-family: 'Fredoka One', sans-serif;">Edit User</h1>
                                ...
                                <div class="row mb-4">
                                            ...
                                            <div class="d-flex gap-5">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="genderMale"
                                                        style="cursor: pointer; margin-left: 0.5rem; color: #333; font-weight: 500; font-size:1rem;">Male</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="gender"
                                                    ...
                                                    <label class="form-check-label" for="genderFemale"
                                                        style="cursor: pointer; margin-left: 0.5rem; color: #333; font-weight: 500; font-size:1rem;">Female</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 ">
                                        ...
                                        <div class="border-2 rounded-4 px-5 py-4 text-center"
                                            ...
                                            <p class="fw-semibold mb-2" style="color: #333; font-size: 0.85rem;">Drop your
                                                files to upload</p>
        ...
        if (saveBtn) {
            saveBtn.addEventListener('click', async (e) => {
                ...
                try {
                    ...
                    const errorMsg = isEditMode ? 'An error occurred while updating the user' :
