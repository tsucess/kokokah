                        ...
                        <table class="table table-hover align-middle users-table">
                            <thead>
                                <tr style="background-color: #f0f0f0; border-bottom: 2px solid #e8e8e8;">
                                    ...
                                    <th style="color: #333; font-weight: 600; padding: 1rem; font-size:14px;">Instructors
                                    </th>
              ...
              <tr style="border-bottom: 1px solid #e8e8e8;">
                ...
                <td style="padding: 1rem;">
                  <div class="d-flex gap-2">
                    <a href="/edituser?id=${user.id}&referrer=instructors" class="btn btn-sm btn-light" style="border: 1px solid #ddd; padding: 0.2rem 0.5rem;" title="Edit">
