...
<main class="terms-main">
    ...
    <!-- Add/Edit Modal -->
    <div class="modal fade" id="addTermModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
                ...
                <form id="termForm">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="termName" placeholder="e.g., First Term" required>
                        </div>
                        <div class="form-group">
    ...
    <script>
        // Sample data
        const terms = [
            { id: 1, name: 'First Term', startDate: '2024-01-15', endDate: '2024-04-15' },
            { id: 2, name: 'Second Term', startDate: '2024-05-01', endDate: '2024-08-01' },
            { id: 3, name: 'Third Term', startDate: '2024-09-01', endDate: '2024-12-15' }
        ];
