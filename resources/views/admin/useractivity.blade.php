...
<main class="activity-logs-main">
  <div class="container-fluid px-5 py-4">
    ...
    <div class="d-flex justify-content-between align-items-start mb-5">
      <div>
        <h1 class="fw-bold mb-2" style="font-size: 2.5rem; color: #004A53; font-family: 'Fredoka One', sans-serif;">User Activity Logs</h1>
        ...
        <table class="table table-hover align-middle activity-table">
          ...
          <tbody>
            ...
            <tr style="border-bottom: 1px solid #e8e8e8;">
              ...
              <td style="padding: 1rem;">
                <div class="d-flex align-items-center">
                  <img src="images/jimmy.png" class="rounded-circle me-3" alt="User" width="40" height="40" style="object-fit: cover;">
            ...
            <tr style="border-bottom: 1px solid #e8e8e8;">
              ...
              <td style="padding: 1rem; color: #666;">Sept 01, 2025</td>
              <td style="padding: 1rem;">
                <span class="badge" style="background-color: #004A53; color: white; padding: 0.5rem 0.75rem; border-radius: 0.5rem;">Active</span>
              </td>
            </tr>
            ...
            <tr style="border-bottom: 1px solid #e8e8e8;">
              ...
              <td style="padding: 1rem;">
                <span class="badge" style="background-color: #ffc107; color: #333; padding: 0.5rem 0.75rem; border-radius: 0.5rem;">Pending</span>
              </td>
            </tr>
            ...
            <tr style="border-bottom: 1px solid #e8e8e8;">
              ...
              <td style="padding: 1rem;">
                <span class="badge" style="background-color: #dc3545; color: white; padding: 0.5rem 0.75rem; border-radius: 0.5rem;">Dropped</span>
              </td>
            </tr>
          </tbody>
        </table>
