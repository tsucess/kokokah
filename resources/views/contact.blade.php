            ...
            <div class="row g-5">
              <div class="col col-12 col-lg-6 d-flex flex-column gap-3 form-container ">
                ...
                <div class="d-flex gap-1 flex-column">
                  ...
                  <input type="text" name="" id="" placeholder="Enter your full name" class="form-input">
                </div>
                <div class="d-flex gap-1 flex-column">
                  <label for="">Email Address</label>
                  <input type="text" name="" id="" placeholder="Enter your email address" class="form-input">
                </div>
                <div class="d-flex gap-1 flex-column">
                  <label for="">Subject</label>
                  <input type="text" name="" id="" placeholder="Select a subject" class="form-input">
                </div>
                <div class="d-flex gap-1 flex-column">
...
respond to all inquiries within 24 hours.</p>
                      <div class="d-flex gap-1 flex-column">
                        ...
                        <a href="#"><i class="fa-solid fa-location-dot"></i>8a Adebayo Mokuolu Street, Anthony Village, Lagos, Nigeria.</a>
                      </div>
                    ...
                    <div class="row">
                      <div class="col d-flex flex-column gap-3 contact-container">
                        ...
                        <div class="d-flex flex-column gap-1">
                          <p class="d-flex justify-content-between align-items-center gap-1 day">Monday - Friday:<span class="time">9:00 AM - 6:00 PM WAT</span></p>
                          <p class="d-flex justify-content-between align-items-center gap-1 day">Saturday:<span class="time">10:00 AM - 2:00 PM WAT</span></p>
                          <p class="d-flex justify-content-between align-items-center gap-1 day">Sunday:<span class="time">Closed</span></p>
                        </div>
                        <div class="link-text">For urgent matters outside of business hours, please email our emergency
support team at <a href="link">support@kokokah.com</a></div>
  ...
  <div class="accordion-item faq-item-container g-5">
    <h2 class="accordion-header">
      <button class="accordion-button faq-item-title" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        What is Kokokah?
      </button>
    </h2>
