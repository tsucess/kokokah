...
<div class="container-fluid" style="background-color: #FDAF22; padding: 60px 40px;">
  <div class="row align-items-center">
    <div class="col-12 col-md-6 col-lg-6">
      <h1 class="fw-bold" style="font-size: 56px; line-height: 1.2; color: #000000; font-family: 'Fredoka', sans-serif; margin-bottom: 24px;">
      ...
      <div class="d-flex flex-column flex-sm-row gap-3">
        <button class="btn fw-bold px-5 py-3" style="background-color: #004A53; color: white; border: none; border-radius: 8px;">Start Using Kokokah</button>
        <button class="btn fw-bold px-5 py-3" style="background-color: white; color: #004A53; border: 2px solid #004A53; border-radius: 8px;">Signup Now</button>
      </div>
    </div>
...
<div class = "container-fluid pt-5  text-center" style = "min-height:600px;  background-repeat: no-repeat;  background-size: cover;">
<div class = "row">
            <h4 class = "mb-2">
                Why Kokokah Is the Best
            </h4>
