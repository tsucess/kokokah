...
<head>
    ...
    <title>@yield('title', 'Kokokah - Learning Management System')</title>
...
<body>
    <!-- Header Banner -->
    <img src="{{ asset('images/kokokah_header.png') }}" class="img-fluid" alt="Banner Image" style="width:100%; height:150px;">
