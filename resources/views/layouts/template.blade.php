...
<div class="position-relative text-center">
  <!-- Background Image -->
  <img src="images/kokokah_header.png" class="img-fluid w-100" alt="Banner Image" style="height: auto; object-fit: cover;">
</div>

        <header class="container-fluid  container__header grid grid-cols-2 items-center  shadow py-10">

            <nav class="container navbar navbar-expand-lg">
                <a class="navbar-brand" href="/"><img src="{{ asset('images/Kokokah_Logo.png') }}" alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="nav-btn">
                        @guest
                            <a href="{{ url('explore') }}" class="btn text-white" style = "background: #004A53;">Explore Kokokah Products</a>
                            <a href="{{ url('demo') }}" class="btn btn-outline-success text-success">Get a Demo</a>
                        @endguest
                    </div>
                ...
                <div class="container row mx-auto">
                    ...
                    <div class="col-12 col-md-3 col-lg-2 mb-3 p-0 text-white">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item mb-2"><a href="/products" class="nav-link p-0 text-white">Products</a></li>

                            <li class="nav-item mb-2"><a href="/howitworks" class="nav-link p-0 text-white">How it works</a>
                            </li>
                            <li class="nav-item mb-2"><a href="/security" class="nav-link p-0 text-white">Security</a></li>
                            <li class="nav-item mb-2"><a href="/testimonial" class="nav-link p-0 text-white">Testimonial</a></li>
                        </ul>
                    </div>
  ...
  <li class="ms-4">
    <a class="text-decoration-none text-white" href="#"><i class="fa-brands fa-facebook"></i></a>
  </li>
  <li class="ms-4">
    <a class="text-decoration-none text-white" href="#"><i class="fa-brands fa-instagram"></i></a>
  </li>
  <li class="ms-4">
    <a class="text-decoration-none text-white" href="#"><i class="fa-brands fa-linkedin-in"></i></a>
  </li>
</ul>
                ...
                <div class="container d-flex flex-column flex-sm-row mb-4 justify-content-between text-white border-top copy__right">
                    <p>Copyright &copy; 2024 Passnownow </p>
                    <p><a href="#" class = "me-2 text-white">Terms and Conditions </a>
                    <a href="#" class = "text-white">Privacy Policy</a></p>
