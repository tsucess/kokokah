                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="lesson-item">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div>
                                ...
                                <p>
                                    This topic covers the fundamentals of creating effective layouts and compositions for
                    ...
                    <div class="lesson-item" style="background-color: #fff;">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <span class="text-muted me-2">Completed Homework</span>
                                <span class="completed-badge" style = "background: #004A53; color:#fff;">0/1</span>
                            </div>
                    ...
                    <div class="card shadow-sm border-0 mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="progress" style="height: 6px;">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: 82%; background-color: #114243;" aria-valuenow="82"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="progress" style="height: 6px;">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: 91%; background-color: #114243;" aria-valuenow="91"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled small">
                                <li class="mb-2"> <img src = "images/celebrate.png" class = "img-fluid"
                                        style = "width:15px; height:15px;"> 65 hours on demand videos</li>
                                <li class="mb-2"> <img src = "images/celebrate.png" class = "img-fluid"
                                        style = "width:15px; height:15px;"> 45 downloadable resources</li>
                                <li class="mb-2"> <img src = "images/celebrate.png" class = "img-fluid"
                                        style = "width:15px; height:15px;"> Access on mobile and laptop</li>
                                <li class="mb-2"> <img src = "images/celebrate.png" class = "img-fluid"
                                        style = "width:15px; height:15px;"> 86 Articles</li>
                                <li class="mb-0"> <img src = "images/celebrate.png" class = "img-fluid"
                                        style = "width:15px; height:15px;"> Certification of completion</li>
                            </ul>
                        </div>
                    </div>
